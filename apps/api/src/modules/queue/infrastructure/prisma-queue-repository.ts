...
const include = { video: true, tasks: { orderBy: { createdAt: 'asc' as const } }, workflowEvents: { orderBy: [{ occurredAt: 'desc' as const }, { id: 'desc' as const }], take: 50 } };
