...
export function AppRoutes() {
  return <Routes><Route element={<AppShell />}><Route path={paths.foundation} element={<FoundationPage />} /><Route path={paths.settings} element={<SettingsPage />} /><Route path={paths.channelProfiles} element={<ProfilesPage />} /><Route path={paths.reviewPolicy} element={<ReviewPolicyPage />} /><Route path={paths.voices} element={<VoicesPage />} /><Route path={paths.discovery} element={<DiscoveryPage />} /><Route path={paths.queue} element={<QueuePage />} /><Route path={paths.workers} element={<WorkersPage />} /><Route path={paths.library} element={<LibraryPage />} /><Route path={paths.libraryVideo} element={<LibraryDetailPage />} /><Route path={paths.studio} element={<StudioPage />} />{reservedPaths.filter((path) => path !== paths.settings && path !== paths.channelProfiles && path !== paths.reviewPolicy && path !== paths.voices && path !== paths.discovery && path !== paths.queue && path !== paths.workers && path !== paths.library && path !== paths.libraryVideo && path !== paths.studio).map((path) => <Route key={path} path={path} element={<FeatureUnavailablePage />} />)}<Route path="*" element={<NotFoundPage />} /></Route></Routes>;
}
