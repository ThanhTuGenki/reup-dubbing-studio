...
/**
 * Đọc projection vận hành cho Dashboard home
 */
...
/**
 * Đọc Review Policy của Channel Profile
 */
export const getChannelReviewPolicy = <ThrowOnError extends boolean = false>(options: Options<GetChannelReviewPolicyData, ThrowOnError>) => {
    return (options.client ?? client).get<GetChannelReviewPolicyResponses, GetChannelReviewPolicyErrors, ThrowOnError>({
...
/**
 * Cập nhật Review Policy của Channel Profile
 */
export const updateChannelReviewPolicy = <ThrowOnError extends boolean = false>(options: Options<UpdateChannelReviewPolicyData, ThrowOnError>) => {
    return (options.client ?? client).patch<UpdateChannelReviewPolicyResponses, UpdateChannelReviewPolicyErrors, ThrowOnError>({
        url: '/channel-profiles/{channelProfileId}/review-policy',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Đọc override và effective Review Policy của Series Profile
 */
export const getSeriesReviewPolicy = <ThrowOnError extends boolean = false>(options: Options<GetSeriesReviewPolicyData, ThrowOnError>) => {
    return (options.client ?? client).get<GetSeriesReviewPolicyResponses, GetSeriesReviewPolicyErrors, ThrowOnError>({
...
/**
 * Cập nhật override Review Policy của Series Profile
 */
export const updateSeriesReviewPolicy = <ThrowOnError extends boolean = false>(options: Options<UpdateSeriesReviewPolicyData, ThrowOnError>) => {
    return (options.client ?? client).patch<UpdateSeriesReviewPolicyResponses, UpdateSeriesReviewPolicyErrors, ThrowOnError>({
        url: '/series-profiles/{seriesProfileId}/review-policy',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Xin presigned upload cho video local
 */
export const requestLocalVideoUpload = <ThrowOnError extends boolean = false>(options: Options<RequestLocalVideoUploadData, ThrowOnError>) => {
    return (options.client ?? client).post<RequestLocalVideoUploadResponses, RequestLocalVideoUploadErrors, ThrowOnError>({
...
/**
 * Cấp lại presigned upload cho video local đang pending
 */
export const refreshLocalVideoUpload = <ThrowOnError extends boolean = false>(options: Options<RefreshLocalVideoUploadData, ThrowOnError>) => {
    return (options.client ?? client).post<RefreshLocalVideoUploadResponses, RefreshLocalVideoUploadErrors, ThrowOnError>({
...
/**
 * Xác minh video local và tạo full pipeline job
 */
export const commitLocalVideoImport = <ThrowOnError extends boolean = false>(options: Options<CommitLocalVideoImportData, ThrowOnError>) => {
    return (options.client ?? client).post<CommitLocalVideoImportResponses, CommitLocalVideoImportErrors, ThrowOnError>({
